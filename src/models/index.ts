...
db.OwnerConfig = require("./owner_config.model")(sequelize, Sequelize);
...
db.Property.hasMany(db.Inspection, {
	foreignKey: "property_id",
	onDelete: "CASCADE",
});
...
db.Property.hasMany(db.Maintenance, {
	foreignKey: "property_id",
	onDelete: "CASCADE",
});
db.Maintenance.belongsTo(db.Property, { foreignKey: "property_id" });
db.Tenant.hasMany(db.Maintenance, { foreignKey: "tenant_id" });
db.Maintenance.belongsTo(db.Tenant, { foreignKey: "tenant_id" });
